...
namespace Engine
{
	...
	Ref<RenderBuffer> RenderBuffer::Create(uint32_t width, uint32_t height, uint32_t internalFormat)
	{
		return CreateRef<OpenGLRenderBuffer>(width, height, internalFormat);
	}
}
